modded class OptionsMenuGame 
{
	...
	void OptionsMenuGame( Widget parent, Widget details_root, GameOptions options, OptionsMenu menu )
	{
		...
		m_VPPATSection = GetGame().GetWorkspace().CreateWidgets("VPPAdminTools/GUI/Layouts/SettingsMenuVPPATSection.layout", m_Root.FindAnyWidget("game_settings_root"));
		m_Root.FindAnyWidget("game_settings_root").Update();

		//Speed
		m_widgetCamSpeed = GetGame().GetWorkspace().CreateWidgets("VPPAdminTools/GUI/Layouts/SettingsMenuElement.layout", m_Root.FindAnyWidget("vppat_settings_root"));
		...
		//Boost multiplier
		m_widgetCamBoost = GetGame().GetWorkspace().CreateWidgets("VPPAdminTools/GUI/Layouts/SettingsMenuElement.layout", m_Root.FindAnyWidget("vppat_settings_root"));
		...
		//Move drag
		m_widgetCamMoveDrag = GetGame().GetWorkspace().CreateWidgets("VPPAdminTools/GUI/Layouts/SettingsMenuElement.layout", m_Root.FindAnyWidget("vppat_settings_root"));
		...
		//Mouse sense
		m_widgetCamMouseSense = GetGame().GetWorkspace().CreateWidgets("VPPAdminTools/GUI/Layouts/SettingsMenuElement.layout", m_Root.FindAnyWidget("vppat_settings_root"));
		...
		//Smoothness
		m_widgetCamSmoothness = GetGame().GetWorkspace().CreateWidgets("VPPAdminTools/GUI/Layouts/SettingsMenuElement.layout", m_Root.FindAnyWidget("vppat_settings_root"));
		...
		//FOV
		m_widgetCamFOV = GetGame().GetWorkspace().CreateWidgets("VPPAdminTools/GUI/Layouts/SettingsMenuElement.layout", m_Root.FindAnyWidget("vppat_settings_root"));
	...
	override bool IsChanged()
  	{
  		if (m_CamSpeed && m_CamSpeed.GetValue() != g_Game.GetVPPATProfileVal(EVPPATProfileOptions.CAM_SPEED))
  			return true;

  		if (m_CamBoost && m_CamBoost.GetValue() != g_Game.GetVPPATProfileVal(EVPPATProfileOptions.CAM_BOOST))
  			return true;

  		if (m_CamMoveDrag && m_CamMoveDrag.GetValue() != g_Game.GetVPPATProfileVal(EVPPATProfileOptions.CAM_MOVE_DRAG))
  			return true;

  		if (m_CamMouseSense && m_CamMouseSense.GetValue() != g_Game.GetVPPATProfileVal(EVPPATProfileOptions.CAM_MOUSE_SENSE))
  			return true;

  		if (m_CamSmoothness && m_CamSmoothness.GetValue() != g_Game.GetVPPATProfileVal(EVPPATProfileOptions.CAM_SMOOTHNESS))
  			return true;

  		if (m_CamFOV && m_CamFOV.GetValue() != g_Game.GetVPPATProfileVal(EVPPATProfileOptions.CAM_FOV))
  			return true;
