		...
		class defs
		{
			...
			class engineScriptModule
			{
				...
				files[]= 
				{
					...
					"VPPAdminTools/VPPNotifications/Definitions",
					"VPPAdminTools/1_Core"
				};
			};
...
class RscMapControl
{
	...
	maxUserMapAlpha=0.2; //0.2
	alphaUserMapFadeStartScale=0.5; //0.5
	alphaUserMapFadeEndScale = 0.80000001; //0.80000001
	showCountourInterval=0; //1
