class BuildingSet
{
   ...
   {
      ref SpawnedBuilding building = GetBuildingByName(name);
   ...
   void SetBuildingsArray(ref array<ref SpawnedBuilding> data)
   {
	  m_Buildings = data;
   }
   ...
   {
      autoptr SpawnedBuilding building = GetBuildingByName(name);
