class DEXML
{
	...
	*/
	...
	void SetDataByField( CallType type, ref ParamsReadContext ctx, ref PlayerIdentity sender, ref Object target )
	{
	...
	void GetDataFromField(int StartPos, int EndPos, string FieldName, ref PlayerIdentity sender)
	{
	...
	void Parse(string ItemClassName, string FeildCatagory, ref PlayerIdentity sender)
	{
		int LinePos    = 0;
		int StartPos   = -1;
		int EndPos     = 0;
	...
	void ReadFromXML(string ItemClassName, string FieldCatagory, ref PlayerIdentity sender)
	{
		string line_content;
